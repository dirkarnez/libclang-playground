...
CXChildVisitResult visitor( CXCursor cursor, CXCursor /* parent */, CXClientData clientData )
{
  ...
  // clang_getFileLocation(clang_getRangeStart(clangCommentRange), &commentFile, nullptr, nullptr, nullptr);
    auto start = clang_getRangeStart(clangCommentRange);
    auto end = clang_getRangeEnd(clangCommentRange);
...
int main( int argc, char** argv )
{
  ...
  CXTranslationUnit tu = clang_parseTranslationUnit( index, argv[1], nullptr, 0, 0, 0, CXTranslationUnit_None );
